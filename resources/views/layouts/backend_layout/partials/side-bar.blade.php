...
___________________________________________________________________
  ...
  @if (Auth::user()->can('view-menu') || Auth::user()->can('create-menu') || Auth::user()->can('edit-menu') || Auth::user()->can('remove-menu'))
  <li class="nav-item">
    <a class="nav-link {{ request()->routeIs('slider*')?'':'collapsed'}}" data-bs-target="#components-slider" data-bs-toggle="collapse" href="#">
        <i class="bi bi-card-image"></i><span>Slider</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="components-slider" class="nav-content collapse {{ request()->routeIs('slider*')?'show':''}}" data-bs-parent="#sidebar-nav">
        @if (Auth::user()->can("view-menu"))
        <li>
        ...
        @if (Auth::user()->Can("create-menu"))
        <li>
        <a href="{{ route('slider.create')}}" class="{{ request()->routeIs('slider.create')?'active':''}}">
  ...
  @if (Auth::user()->can('view-menu') || Auth::user()->can('create-menu') || Auth::user()->can('edit-menu') || Auth::user()->can('remove-menu'))
  <li class="nav-item">
    <a class="nav-link {{ request()->routeIs('mapsdata*')?'':'collapsed'}}" data-bs-target="#components-mapsdata" data-bs-toggle="collapse" href="#">
        <i class="bi bi-card-image"></i><span>Maps Data</span><i class="bi bi-chevron-down ms-auto"></i>
    </a>
    <ul id="components-mapsdata" class="nav-content collapse {{ request()->routeIs('mapsdata*')?'show':''}}" data-bs-parent="#sidebar-nav">
        @if (Auth::user()->can("view-menu"))
        <li>
            <a href="{{ route('mapsdata.index') }}" class="{{ request()->routeIs('mapsdata.index')?'active':''}}">
        ...
        @if (Auth::user()->Can("create-menu"))
        <li>
        <a href="{{ route('mapsdata.create')}}" class="{{ request()->routeIs('mapsdata.create')?'active':''}}">
