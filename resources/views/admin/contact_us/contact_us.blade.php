    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Contact us Message List</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title" style="float">Contacts us Message List</h5>

                        <p>All Contact us message Listed Here.....</p>
                                ...
                                <ul class="dropdown-menu bg-danger ">
                                    <li>
                                        <a href="javascript:void(0);"
                                            class="dropdown-item text-white drop-hover to-perform-message"
                                ...
                                @endphp
                                    @foreach ($data as $message)
                                        <tr>
                                            ...
                                            <td>
                                                {{ ucfirst($message->email) }}
                                            </td>
                                            <td style="white-space: normal;
                                            word-wrap: break-word;">{{ucfirst($message->subject)}}</td>
                                            <td> {{ Str::limit($message->message, 20, $end = '..') }} </td>
                                            <td>
                                                <td>{{ date('M jS Y', strtotime($message->created_at)) }}</td>
                                                <td>
                                                <a href="#" class="btn btn-sm btn-primary fa fa-eye" data-toggle="modal"
                                                    data-target="#exampleModalCenter{{ $message->id }}"></a>
                                                ...
                                                <a href="javascript:;" data-id="{{ $message->id }}"
                                                    class="btn btn-sm btn-danger btn-style delete-message">
...
@section('backend-js')
    ...
    <script>
        ...
        $(document).on('click', '.delete-message', function(e) {
            e.preventDefault();
            var myAction = "{{ route('contact_us_destroy', 'contcatValue') }}"
