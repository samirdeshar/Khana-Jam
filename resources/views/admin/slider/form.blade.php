...
@section('title', 'Admin || Slider-Form')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Sliders List</a></li>
        ...
        <div class="card-body">
            ...
            <div>
                @isset($data)
                    ...
                    {{ Form::open(['url' => route('slider.update', $data->id), 'files' => true]) }}
                    @method('put')
                @else
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <div class="col-6 mb-2">
                            {{ Form::label('external_link', 'External Link', ['class'=>'form-label']) }}
                            {{ Form::text('external_link', @$data->external_link, ['class' => 'form-control  ' . ($errors->has('title') ? 'is-invalid' : ''), 'placeholder' => 'Enter link .....', 'required' => false]) }}
